...
//				throw new Exception("Shuffle only defined on one-dimensional arrays!");
		...
		public static Vector2 V2Multiply(Vector2 v, float r)
		{
            return new Vector2(v.x * r, v.y * r);
		}
		public static Vector2 V2Multiply(Vector2 v, int r) => V2Multiply(v, (float)r);
		public static Vector3 V3Multiply(Vector3 v, float r)
		{
			return new Vector3(v.x * r, v.y * r, v.z * r);
		}
		public static Vector3 V3Multiply(Vector3 v, int r) => V3Multiply(v, (float)r);
